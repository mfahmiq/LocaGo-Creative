...
const Footer: React.FC = () => {
    ...
    const quickLinks = ['home', 'services', 'pricing', 'contact', 'about'];
            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-12 mb-12">
                    ...
                    <div className="space-y-6">
                        ...
                        {/* Let's strictly follow the request: 4 columns logic usually fits best: Branding, Quick Links, Contacts, Socials/Newsletter or combined. 
                            The user listed 5 items. 
                            1. Identity & Branding
                            2. Quick Links
                            3. Contact Directly
                            4. Social Media
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-start space-x-3 group">
                                <div className="p-2 rounded-lg bg-purple-50 dark:bg-purple-900/20 text-purple-600 dark:text-purple-400 group-hover:bg-purple-100 dark:group-hover:bg-purple-900/40 transition-colors">
                            ...
                            <li className="flex items-start space-x-3 group">
                                <div className="p-2 rounded-lg bg-pink-50 dark:bg-pink-900/20 text-pink-600 dark:text-pink-400 group-hover:bg-pink-100 dark:group-hover:bg-pink-900/40 transition-colors">
