...
export const translations = {
    en: {
        ...
        hero: {
            ...
            titleStart: 'We Build',
            titleGradient: 'Digital Experiences',
            titleEnd: 'That Matter.',
            description: 'We are a team of passionate developers and designers creating specialized web solutions that drive growth and innovation.',
    ...
    id: {
        ...
        hero: {
            badge: '🚀 Transformasi Digital Anda',
            titleStart: 'Kami Bangun',
            titleGradient: 'Pengalaman Digital',
            titleEnd: 'Yang Berarti.',
            description: 'Kami adalah tim pengembang dan desainer bersemangat yang menciptakan solusi web khusus untuk mendorong pertumbuhan dan inovasi.',
